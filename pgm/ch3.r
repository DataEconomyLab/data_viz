...
library(zoo)
econ1 <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/gdp.csv", header=T)
...
library(ggplot2)
# 데이터 불러오기
gdp_1   <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/gdp.csv", header=TRUE)
연도     <- seq(as.Date("1970-01-01"), as.Date("2013-12-01"), "quarter")
...
cycle1  <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/cycle.csv",header=TRUE)
연도    <- seq(as.Date("1970-01-01"), as.Date("2014-06-01"), "month")
cycle   <- xts(cycle1[,2],연도)
# 경기 기준순환일 데이터를 가져와서 정리
refdate <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/refdate1.csv",header=TRUE)
yrng <- range(cycle)
...
library(ggplot2)
# 데이터 불러오기
climate_kr1  <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/climate.csv", header=TRUE)
...
library(ggplot2)
# 데이터 불러오기
climate_kr1  <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/climate1.csv", header=TRUE)
...
library(ggplot2)
# 데이터 불러오기
cb <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/cb.csv", header=TRUE)
cb$경상수지 <- cb$경상수지/100
cb$pos <- cb$경상수지 >=0
# 그래프 그리기
...
library(plyr)
# 데이터 불러온 후 연령대별로 재정렬
pop_kr1  <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/krpop.csv", header=TRUE)
...
library(reshape2)
# 데이터 불러옴
gdp_s1 <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/gdp_sh.csv", header=TRUE)
# 데이터 불러온 후 재정렬
...
library(xts)
# 데이터 불러오기
inven1  <- read.csv("https://raw.githubusercontent.com/data-better/data_viz/master/data/ch4/inven_cy.csv",header=TRUE)
